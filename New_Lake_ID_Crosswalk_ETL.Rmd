...
```{r}
knitr::include_graphics('./Processing_flow.PNG')
```
...
# save(lagos_sf, file = 'lagos_sf.RData')
load('lagos_sf.RData')
glimpse(lagos_sf)
```
...
# save(wqp_orig, file = 'wqp_orig.RData')
load('wqp_orig.RData')
glimpse(wqp_orig)
```
...
# save(lagos_10, file = "lagos_10.RData")
load('lagos_10.RData')
...
# save(lagos_100, file = "lagos_10.RData")
load('lagos_100.RData')
...
# save(nhd_xref, file = 'nhd_xref.RData')
load('nhd_xref.RData')
...
#   st_transform(ALBERS_USGS) # no actual change, just proj4string housekeeping.
# save(lagosNE_orig, file = 'lagosNE_orig.RData')
load('lagosNE_orig.RData')
...
# # unlink(tf)
# # save(v1_v2_xwalk, file = 'v1_v2_xwalk.RData')
# load('v1_v2_xwalk.RData')
# glimpse(v1_v2_xwalk)
```
